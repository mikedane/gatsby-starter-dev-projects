...
export type SiteSiteMetadataFilterInput = {
  ...
  dog?: Maybe<StringQueryOperatorInput>
}
...
export type IndexMarkdownQueryVariables = {}

export type IndexMarkdownQuery = {
  allMarkdownRemark: Pick<MarkdownRemarkConnection, 'totalCount'> & {
    edges: Array<{
      node: Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'> & {
